...
<div class="gallery js-isotope" style="background: white url('img/section-pattern.webp') repeat;" data-isotope-options='{ "itemSelector": ".gallery-inner", "masonry": { "columnWidth": ".grid-sizer" } }'>
    ...
    <div class="gallery-inner smartphone">
        ...
        <img alt="thumbnail" class="galleryImage" src="img/gallery/thumb/huissier-nancy-djp.com_sm-thumb.webp">
    </div>
    <div class="gallery-inner tablette">
        <div class="caption">
            <div class="captionWrapper valign">
